...
return (
    ...
    <div className="Parent-Container">
        ...
        <div className="leftSideVisPage">
            ...
            <p>
            Delta 10 is the home of Doctrine, Tactics, Lessons Learned and
            Wargaming for the United States Space Force!
            </p>
            <h2 className="homePageTitle">Our Values:</h2>
            <p>
            Delta 10 values Connection between Guardians, Families and
            Leaders. We created this Booster Club to better connect our
            teammates to one another!
            </p>
            <h2 className="homePageTitle">How Can You Help:</h2>
            <p>
            Help Make this Organization better by Donating, Volunteering, or
    ...
    <div className="Landing_wrapper"></div>
    </>
);
};
